    ...
    return (
        <div className="animated slideInUpTiny animation-duration-3">
            ...
            <div className="row mb-md-4">
                <CardBox cardStyle="p-0 border-0" heading={<IntlMessages id="component.appbar.simple"/>}
                         headerOutside>
                    <SimpleAppBar/>
                </CardBox>

                <CardBox cardStyle="p-0 border-0" heading={<IntlMessages id="component.appbar.colored"/>}
                         headerOutside>
                    <ButtonAppBar/>
                </CardBox>
            </div>
            ...
            <div className="row">
                <CardBox styleName="col-lg-12" cardStyle="p-0 border-0"
