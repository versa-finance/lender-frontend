    ...
    return (
        <div className="animated slideInUpTiny animation-duration-3">
            ...
            <div className="row mb-md-4">
                ...
                <CardBox styleName="col-lg-4 col-sm-6 col-12" cardStyle="p-0 border-0"
                ...
                <CardBox styleName="col-lg-4 col-12" cardStyle="p-0 border-0"
            ...
            <div className="row mb-md-4">
                <CardBox styleName="col-md-6 col-12" heading={<IntlMessages
                    ...
                    <blockquote className="blockquote">
                        <div className="media">
                            <img className="user-avatar mr-3 mb-2" alt="Remy Sharp"
                ...
                <CardBox styleName="col-md-6 col-12" heading={<IntlMessages
                    ...
                    <blockquote className="blockquote blockquote-reverse">
                        <div className="media">
                            ...
                            <img className="user-avatar ml-3 mb-2" alt="Remy Sharp"
                                 src="http://via.placeholder.com/150x150"/>
                        </div>
                        <footer className="blockquote-footer">Quote author with <cite title="Source Title">Source
                            Title</cite></footer>
