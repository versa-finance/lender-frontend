...
const Cards = ({match}) => {
    return (
        <div className="animated slideInUpTiny animation-duration-3">
            ...
            <div className="row mb-md-4">
                ...
                <div className="col-lg-4 col-md-12 col-12">
                    <div className="row">
                        ...
                        <div className="col-lg-12 col-md-6 col-12">
                            <NormalCard/>
                            <NormalCard cardStyle="bg-primary text-white border-0"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="row">
                <div className="col-lg-4 col-sm-6 col-12">
                    <SolidCards headerText="Primary Card" cardStyle="bg-primary text-white border-0"/>
                </div>

                <div className="col-lg-4 col-sm-6 col-12">
                    <SolidCards headerText="Warning Card" cardStyle="bg-warning text-white border-0"/>
                </div>

                <div className="col-lg-4 col-sm-6 col-12">
                    <SolidCards headerText="Success Card" cardStyle="bg-success text-white border-0"/>
                </div>

                <div className="col-lg-4 col-sm-6 col-12">
                    <SolidCards headerText="Danger Card" cardStyle="bg-danger text-white border-0"/>
                </div>

                <div className="col-lg-4 col-sm-6 col-12">
                    <SolidCards headerText="Info Card" cardStyle="bg-info text-white border-0"/>
                </div>

                <div className="col-lg-4 col-sm-6 col-12">
                    <SolidCards headerText="Dark Card" cardStyle="bg-dark text-white border-0"/>
                </div>
