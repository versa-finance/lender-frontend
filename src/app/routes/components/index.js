...
const Components = ({match}) => (
    <div className="app-wrapper">
        <Switch>
            ...
            <Route path={`${match.url}/button-group`}
                   component={asyncComponent(() => import('./routes/buttonGroup'))}/>
            <Route path={`${match.url}/breadcrumbs`}
            ...
            <Route path={`${match.url}/color-picker`}
                   component={asyncComponent(() => import('./routes/colorPicker'))}/>
            <Route path={`${match.url}/modals`} component={asyncComponent(() => import('./routes/modals'))}/>
            ...
            <Route path={`${match.url}/progressbar`}
