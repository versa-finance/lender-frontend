            ...
            <div className="dashboard animated slideInUpTiny animation-duration-3">
                ...
                <div className="row">
                    <div className="col-lg-3 col-sm-6 col-12">
                        <ReportBox
                            styleName="bg-teal accent-4 text-white border-0"
                            title="85K+"
                    ...
                    <div className="col-lg-3 col-sm-6 col-12 overflow-hidden">
                        <ReportBox
                            styleName="bg-red text-white border-0"
                            title="526"
                            detail={<IntlMessages id="dashboard.newArticles"/>}
                            subHeadingColor="text-white"
                        >
                            <PieChart>
                                <Pie dataKey="amt" data={pieChartData} cx="50%" cy="50%" innerRadius={25}
                                     outerRadius={40}
                                     fill="#ffc658"/>
                                <Tooltip/>
                            </PieChart>
                    ...
                    <div className="col-lg-3 col-sm-6 col-12">
                        <ReportBox
                            styleName="bg-purple text-white border-0"
                            title="232"
                ...
                <div className="row">
                    ...
                    <div className="col-lg-8">
                        <div className="jr-card">
                            ...
                            <div className="jr-card-body">
                                <div className="row">
                                    {article.map((article, index) => <PopularArticles key={index}
                                                                                      article={article}/>)}
                                </div>
                            </div>
                        </div>
