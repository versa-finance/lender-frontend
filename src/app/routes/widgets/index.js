                        ...
                        <div className="col-xl-7 col-12">
                            <div className="row">
                                ...
                                <div className="col-xl-5 col-lg-6 col-sm-5 col-12">
                                    <ChartCard styleName="bg-primary jr-chart-or text-white border-0">
                    ...
                    <div className="row">
                        <div className="col-lg-8 col-12">
                            <div className="jr-card">
                                ...
                                <div className="row">
                                    {products.map((product, index) => <PopularProduct key={index}
                                                                                      product={product}/>)}
                                </div>
                            ...
                            <div className="jr-card">
                                <div className="jr-card-header">
                                    <div className="d-flex align-items-center">
                                        <h3 className="mb-0">Latest Postsdd</h3>
                                        <span className="icon-btn ml-auto size-30">
                                            ...
                                            <ul className="social-link">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)"><i
                                                        className="zmdi zmdi-bookmark"/></a>
                                                </li>
                                                <li>
